      ...
      <nav class="space-x-6 flex items-center">
        ...
        <?php if (isset($_SESSION['usuario'])): ?>
          <?php
            ...
            $fotoUsuario = htmlspecialchars($_SESSION['usuario']['foto']);
            $fotoFinal = (!empty($fotoUsuario) && file_exists($fotoUsuario)) ? $fotoUsuario : 'imagenes/default.jpg';
          ?>
          <div class="flex items-center space-x-4 bg-gray-100 px-4 py-2 rounded-lg ml-4">
            ...
            <div>
              ...
              <span class="block text-blue-700 font-semibold"><?= $nombreUsuario ?></span>
            </div>
